...
<h1>Recht auf Beschwerde bei der zuständigen Aufsichtsbehoerde</h1>
<p>
	...
	Datenschutzbeauftragten sowie deren Kontaktdaten bereit: <a
...
<h1>Recht auf Auskunft, Berichtigung, Sperrung, Löschung</h1>
<p>
...
<p>
	...
	verschlüsselte Verbindung an der „https://“ Adresszeile Ihres Browsers und am SchlossSymbol in der
	Browserzeile.
</p>
<h1>Vimeo</h1>
<p>
	Für Integration und Darstellung von Videoinhalten nutzt unsere Website Plugins von Vimeo. Anbieter
	des Videoportals ist die Vimeo Inc., 555 West 18th Street, New York, New York 10011, USA.
</p>
<p>
	Bei Aufruf einer Seite mit integriertem Vimeo-Plugin wird eine Verbindung zu den Servern von Vimeo
	hergestellt. Vimeo erfährt hierdurch, welche unserer Seiten Sie aufgerufen haben. Vimeo erfährt
	Ihre IP-Adresse, selbst wenn Sie nicht beim Videoportal eingeloggt sind oder dort kein Konto
	besitzen. Es erfolgt eine Übermittlung der von Vimeo erfassten Informationen an Server des
	Videoportals in den USA.
</p>
<p>
	Vimeo kann Ihr Surfverhalten direkt Ihrem persönlichen Profil zuordnen. Durch vorheriges Ausloggen
	haben Sie die Möglichkeit, dies zu unterbinden.
</p>
<p>
	Einzelheiten zum Umgang mit Nutzerdaten finden Sie in der Datenschutzerklärung von Vimeo unter: <a
		href="https://vimeo.com/privacy"
		rel="nofollow">https://vimeo.com/privacy</a
	>.
</p>
<p>
	Quelle: Datenschutz-Konfigurator von <a
		href="https://mein-datenschutzbeauftragter.de"
		rel="nofollow">mein-datenschutzbeauftragter.de</a
	>
</p>
